package io.jimmytai.flutter_tencent_vap.view
...
import io.jimmytai.flutter_tencent_vap.utils.TencentVapScaleTypeUtil
import java.io.File
...
open class VapView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0):
    ...
    private val scaleTypeUtil = TencentVapScaleTypeUtil()
     ...
     * 設置內容的位置
     */
    open fun setAlignment(alignment: FlutterVapAlignment) {
